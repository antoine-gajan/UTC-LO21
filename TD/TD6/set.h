...
namespace Set {
    ...
    private:
        ...
        struct Handler {
            Jeu* instance;
            Handler() :instance(nullptr) {} // pointeur initialisé à la création de l'objet Handler
            ~Handler() { delete instance; } // l'instance est libérée au moment de la destruction (automatique) du Handler
        };
